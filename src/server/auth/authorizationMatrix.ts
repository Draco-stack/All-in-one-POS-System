...
export const DATABASE_SCHEMA_OWNERSHIP_MATRIX: Record<string, DatabaseModelClassification> = {
  ...
  PendingRegistration: {
    ...
    classification: ModelOwnershipScope.PLATFORM_SCOPED,
    tenantKey: 'email',
    platformAccessOnly: false,
    allowedActors: [ActorRole.ANONYMOUS, ActorRole.OWNER, ActorRole.PLATFORM_ADMIN, ActorRole.EXECUTIVE_ADMIN],
    forbiddenActors: [ActorRole.SUSPENDED_USER],
    enforcementMechanism: 'Pre-organization registration lifecycle with salted SHA-256 verification hash and TTL expiration',
  },
  MenuItemVariant: {
    modelName: 'MenuItemVariant',
    classification: ModelOwnershipScope.TENANT_SCOPED,
    tenantKey: 'organizationId',
    platformAccessOnly: false,
    allowedActors: [ActorRole.OWNER, ActorRole.ADMIN, ActorRole.MANAGER, ActorRole.CASHIER, ActorRole.SERVER, ActorRole.PLATFORM_ADMIN],
    forbiddenActors: [ActorRole.SUSPENDED_USER, ActorRole.ANONYMOUS],
    enforcementMechanism: 'Variant bound to organizationId and menu item parent',
  },
  ModifierGroup: {
    ...
    allowedActors: [ActorRole.OWNER, ActorRole.ADMIN, ActorRole.MANAGER, ActorRole.CASHIER, ActorRole.SERVER, ActorRole.PLATFORM_ADMIN],
    forbiddenActors: [ActorRole.SUSPENDED_USER, ActorRole.ANONYMOUS],
    enforcementMechanism: 'Modifier group bound to organizationId; mutations restricted to tenant manager/owner',
  },
  ModifierOption: {
    ...
    allowedActors: [ActorRole.OWNER, ActorRole.ADMIN, ActorRole.MANAGER, ActorRole.CASHIER, ActorRole.SERVER, ActorRole.PLATFORM_ADMIN],
    forbiddenActors: [ActorRole.SUSPENDED_USER, ActorRole.ANONYMOUS],
    enforcementMechanism: 'Modifier option bound to organizationId and modifier group parent',
  },
  MenuItemModifierGroup: {
    ...
    allowedActors: [ActorRole.OWNER, ActorRole.ADMIN, ActorRole.MANAGER, ActorRole.CASHIER, ActorRole.SERVER, ActorRole.PLATFORM_ADMIN],
    forbiddenActors: [ActorRole.SUSPENDED_USER, ActorRole.ANONYMOUS],
    enforcementMechanism: 'Link table bound to organizationId with menu item and modifier group references',
  },
  BranchMenuItem: {
    ...
    allowedActors: [ActorRole.OWNER, ActorRole.ADMIN, ActorRole.MANAGER, ActorRole.CASHIER, ActorRole.SERVER, ActorRole.PLATFORM_ADMIN],
    forbiddenActors: [ActorRole.SUSPENDED_USER, ActorRole.ANONYMOUS],
    enforcementMechanism: 'Branch specific item configuration bound to organizationId and branchId',
  },
  Vendor: {
    modelName: 'Vendor',
    classification: ModelOwnershipScope.TENANT_SCOPED,
    ...
    allowedActors: [ActorRole.OWNER, ActorRole.ADMIN, ActorRole.MANAGER, ActorRole.PLATFORM_ADMIN],
    forbiddenActors: [ActorRole.SUSPENDED_USER, ActorRole.ANONYMOUS],
    enforcementMechanism: 'Supplier vendor registry bound to tenant organizationId',
  },
  Ingredient: {
    ...
    allowedActors: [ActorRole.OWNER, ActorRole.ADMIN, ActorRole.MANAGER, ActorRole.PLATFORM_ADMIN],
    forbiddenActors: [ActorRole.SUSPENDED_USER, ActorRole.ANONYMOUS],
    enforcementMechanism: 'Raw material ingredient catalog bound to organizationId',
  },
  StockMovement: {
    ...
    allowedActors: [ActorRole.OWNER, ActorRole.ADMIN, ActorRole.MANAGER, ActorRole.PLATFORM_ADMIN],
    forbiddenActors: [ActorRole.SUSPENDED_USER, ActorRole.ANONYMOUS],
    enforcementMechanism: 'Immutable stock movement audit trail scoped to organizationId',
  },
  Recipe: {
    modelName: 'Recipe',
    classification: ModelOwnershipScope.TENANT_SCOPED,
    ...
    allowedActors: [ActorRole.OWNER, ActorRole.ADMIN, ActorRole.MANAGER, ActorRole.PLATFORM_ADMIN],
    forbiddenActors: [ActorRole.SUSPENDED_USER, ActorRole.ANONYMOUS],
    enforcementMechanism: 'Recipe Bill of Materials bound to tenant organizationId',
  },
  RecipeItem: {
    modelName: 'RecipeItem',
    classification: ModelOwnershipScope.TENANT_SCOPED,
    tenantKey: 'recipe.organizationId',
    platformAccessOnly: false,
    allowedActors: [ActorRole.OWNER, ActorRole.ADMIN, ActorRole.MANAGER, ActorRole.PLATFORM_ADMIN],
    forbiddenActors: [ActorRole.SUSPENDED_USER, ActorRole.ANONYMOUS],
    enforcementMechanism: 'Recipe line item bound through parent Recipe tenant organizationId',
  },
  WasteLog: {
    modelName: 'WasteLog',
    classification: ModelOwnershipScope.TENANT_SCOPED,
    ...
    allowedActors: [ActorRole.OWNER, ActorRole.ADMIN, ActorRole.MANAGER, ActorRole.PLATFORM_ADMIN],
    forbiddenActors: [ActorRole.SUSPENDED_USER, ActorRole.ANONYMOUS],
    enforcementMechanism: 'Food waste and spoilage audit log scoped to organizationId',
  },
  StockTransfer: {
    ...
    allowedActors: [ActorRole.OWNER, ActorRole.ADMIN, ActorRole.MANAGER, ActorRole.PLATFORM_ADMIN],
    forbiddenActors: [ActorRole.SUSPENDED_USER, ActorRole.ANONYMOUS],
    enforcementMechanism: 'Inter-branch ingredient transfers scoped to organizationId',
  },
  StockTransferItem: {
    modelName: 'StockTransferItem',
    classification: ModelOwnershipScope.TENANT_SCOPED,
    tenantKey: 'transfer.organizationId',
    platformAccessOnly: false,
    allowedActors: [ActorRole.OWNER, ActorRole.ADMIN, ActorRole.MANAGER, ActorRole.PLATFORM_ADMIN],
    forbiddenActors: [ActorRole.SUSPENDED_USER, ActorRole.ANONYMOUS],
    enforcementMechanism: 'Transfer line item scoped through parent StockTransfer tenant',
  },
  StockCountSession: {
    modelName: 'StockCountSession',
    classification: ModelOwnershipScope.TENANT_SCOPED,
    tenantKey: 'organizationId',
    branchKey: 'branchId',
    platformAccessOnly: false,
    allowedActors: [ActorRole.OWNER, ActorRole.ADMIN, ActorRole.MANAGER, ActorRole.PLATFORM_ADMIN],
    forbiddenActors: [ActorRole.SUSPENDED_USER, ActorRole.ANONYMOUS],
    enforcementMechanism: 'Physical stock audit reconciliation session bound to organizationId',
  },
  StockCountItem: {
    modelName: 'StockCountItem',
    classification: ModelOwnershipScope.TENANT_SCOPED,
    tenantKey: 'session.organizationId',
    platformAccessOnly: false,
    allowedActors: [ActorRole.OWNER, ActorRole.ADMIN, ActorRole.MANAGER, ActorRole.PLATFORM_ADMIN],
    forbiddenActors: [ActorRole.SUSPENDED_USER, ActorRole.ANONYMOUS],
    enforcementMechanism: 'Stock audit count line item bound through parent StockCountSession',
  },
  VendorIngredient: {
    modelName: 'VendorIngredient',
    classification: ModelOwnershipScope.TENANT_SCOPED,
    tenantKey: 'organizationId',
    platformAccessOnly: false,
    allowedActors: [ActorRole.OWNER, ActorRole.ADMIN, ActorRole.MANAGER],
    forbiddenActors: [ActorRole.CASHIER, ActorRole.SERVER, ActorRole.RIDER, ActorRole.SUSPENDED_USER, ActorRole.ANONYMOUS],
    enforcementMechanism: 'Prisma query with organizationId filter',
  },
  PurchaseOrder: {
    ...
    allowedActors: [ActorRole.OWNER, ActorRole.ADMIN, ActorRole.MANAGER],
    forbiddenActors: [ActorRole.CASHIER, ActorRole.SERVER, ActorRole.RIDER, ActorRole.SUSPENDED_USER, ActorRole.ANONYMOUS],
    enforcementMechanism: 'Prisma query with organizationId and branchId filter',
  },
  PurchaseOrderItem: {
    modelName: 'PurchaseOrderItem',
    classification: ModelOwnershipScope.BRANCH_SCOPED,
    tenantKey: 'organizationId', // via parent relation in reality, but for matrix we map it logically or use parent binding
    platformAccessOnly: false,
    allowedActors: [ActorRole.OWNER, ActorRole.ADMIN, ActorRole.MANAGER],
    forbiddenActors: [ActorRole.CASHIER, ActorRole.SERVER, ActorRole.RIDER, ActorRole.SUSPENDED_USER, ActorRole.ANONYMOUS],
    enforcementMechanism: 'Bound to PurchaseOrder ownership',
  },
  GoodsReceipt: {
  ...
  GoodsReceiptItem: {
    ...
    allowedActors: [ActorRole.OWNER, ActorRole.ADMIN, ActorRole.MANAGER],
    forbiddenActors: [ActorRole.CASHIER, ActorRole.SERVER, ActorRole.RIDER, ActorRole.SUSPENDED_USER, ActorRole.ANONYMOUS],
    enforcementMechanism: 'Bound to GoodsReceipt ownership',
  },
  UserBranchAssignment: {
    modelName: 'UserBranchAssignment',
    classification: ModelOwnershipScope.BRANCH_SCOPED,
    tenantKey: 'organizationId',
    branchKey: 'branchId',
    platformAccessOnly: false,
