...
export const CustomerManageModal: React.FC<CustomerManageModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-900/40 dark:bg-black/60 backdrop-blur-md flex items-center justify-center p-4">
      <div className="bg-gradient-to-b from-stone-900 to-[#121212] rounded-2xl border border-slate-300 dark:border-white/10 ring-1 ring-white/10 shadow-2xl w-full max-w-md overflow-hidden text-slate-900 dark:text-stone-100 animate-in fade-in duration-150">
        {/* Header */}
        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-3.5">
          <div>
            ...
            <input
              ...
              className="w-full bg-stone-950/90 border border-slate-300 dark:border-white/10 rounded-xl px-3.5 py-2.5 text-xs text-white placeholder:text-stone-600 focus:outline-none focus:border-emerald-500/50 focus:ring-1 focus:ring-emerald-500/30 transition-all shadow-inner"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full bg-stone-950/90 border border-slate-300 dark:border-white/10 rounded-xl px-3.5 py-2.5 text-xs text-white font-mono font-bold placeholder:text-stone-600 focus:outline-none focus:border-emerald-500/50 focus:ring-1 focus:ring-emerald-500/30 transition-all shadow-inner"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full bg-stone-950/90 border border-slate-300 dark:border-white/10 rounded-xl px-3.5 py-2 text-xs text-white placeholder:text-stone-600 focus:outline-none focus:border-emerald-500/50 focus:ring-1 focus:ring-emerald-500/30 transition-all shadow-inner"
            />
          </div>
