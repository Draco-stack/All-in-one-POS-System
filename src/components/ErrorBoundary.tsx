...
export class ErrorBoundary extends Component<Props, State> {
  ...
  public render() {
    if (this.state.hasError) {
      return (
        <div className="min-h-screen bg-white dark:bg-stone-950 text-slate-900 dark:text-stone-100 flex items-center justify-center p-6">
          <div className="max-w-md w-full bg-white dark:bg-stone-900 border border-red-500/30 rounded-2xl p-8 shadow-2xl text-center">
            ...
            <h2 className="text-xl font-bold text-slate-900 dark:text-stone-100 mb-2">
