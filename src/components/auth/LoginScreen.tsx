    ...
    >
      ...
      >
        ...
        <div className="flex flex-col items-center text-center mb-6">
          ...
          <p className="text-xs text-stone-300/80 mt-2 font-medium">Commercial Restaurant Operating System</p>
        </div>
        ...
        <form onSubmit={handleLoginSubmit} className="space-y-4">
          ...
          <div className="flex items-center justify-between text-xs text-stone-400 mt-3 px-1">
            <a href="/get-started" className="hover:text-amber-400 font-medium transition">
